...
public class WebSocketImpl {
     ...
     * charles web proxy
     */
    private static final Proxy proxy = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("localhost", 8888));

    /**
     * main okhttp client
     * uncomment unsafe client to allow self-signed certificated
     */
    private static OkHttpClient client = new OkHttpClient.Builder() //getUnsafeOkHttpClientBuilder()
